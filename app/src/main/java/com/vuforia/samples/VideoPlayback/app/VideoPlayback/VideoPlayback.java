...
import static com.vuforia.CameraDevice.FOCUS_MODE.FOCUS_MODE_NORMAL;
...
//    private native boolean activateFlash(boolean flash);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mMovieName[STONES] = "VideoPlayback/manual.mp4";
        mMovieName[CHIPS] = "VideoPlayback/manual.mp4";
...
//          "VideoPlayback/Hand-Touch-icon.png", getAssets()));
//        mTextures.add(Texture.loadTextureFromApk(
//            "VideoPlayback/Hand-Touch-icon.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VideoPlayback/button2.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VideoPlayback/button2.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VideoPlayback/button2.png",
    ...
    public boolean doLoadTrackersData()
    {
        ...
        // Load the data sets:
        if (!dataSetStonesAndChips.load("xuv.xml",
    ...
    public void onVuforiaStarted()
    {
        ...
        if(!CameraDevice.getInstance().setFocusMode(CameraDevice.FOCUS_MODE.FOCUS_MODE_CONTINUOUSAUTO))
        {
            ...
            {
                CameraDevice.getInstance().setFocusMode(FOCUS_MODE_NORMAL);
            }
        }
...
//                getString(R.string.menu_flash), CMD_FLASH, false);
    ...
    private boolean activateFlash(boolean b) {
        return true;
    }
